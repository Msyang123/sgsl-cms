 ...
 */
@Component
public class CmsMapListDirective extends AbstractTemplateDirective {
    ...
    public void execute(RenderHandler handler) throws IOException, Exception {
        ...
        PageHandler page = service.getPage(handler.getString("store_name"),handler.getInteger("pageIndex", 1), handler.getInteger("count", 30));
