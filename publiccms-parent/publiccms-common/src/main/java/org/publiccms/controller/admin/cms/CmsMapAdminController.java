 ...
 */
@Controller
@RequestMapping("cmsMap")
public class CmsMapAdminController extends AbstractController {
    @Autowired
     ...
     */
    @RequestMapping("save")
    public String save(CmsMap entity,HttpServletRequest request, HttpSession session, ModelMap model) {
   ...
   /* @RequestMapping("query")
    ...
    @ResponseBody
    public Object queryObj(Long id){
        CmsMap cmsMap=service.getEntity(id);
        return cmsMap;
    }
